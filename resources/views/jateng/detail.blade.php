...
@section('content')
<h2>Perkiraan Cuaca Wilayah Jawa Tengah Sungai Citanduy </h2>

<div class="mt-4 mb-2 row">
    <div class="col-md-2">
        <div class="form-inline">
            <label class="mr-2">Tanggal Penarikan:</label>
    ...
    $(document).ready(function () {
        var table = $('#dataTable').DataTable({
            ...
            columns: [
                ...
                { data: 'jawa_tengah.kecamatan', name: 'jawa_tengah.kecamatan' },
