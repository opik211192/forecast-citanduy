...
class testJbarat extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'test-jbarat';
     ...
     * @var string
     */
    protected $description = 'ambil data jawa barat';
    ...
    public function handle()
    {
        ...
        try {
            Log::channel('single')->info('test import data Jawa Barat.');
            ...
            Log::error("error test jawa barat");
        }
    }
}
