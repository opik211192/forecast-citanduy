...
@section('title', 'Data Cuaca Jawa Barat')
@push('styles')
<style>
    .custom-table {
        font-size: 12px;
    ...
    .table-responsive {
        margin: 0;
        /* Tambahkan properti margin dengan nilai 0 */
    }
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (weatherCounts) {
                        ...
                        console.error('Data weathercount kosong atau null..');
                    }
                    ...
                    if (response.groupedData && Object.keys(response.groupedData).length > 0) {
                        console.log(response.groupedData);
                        // Buat tabel
